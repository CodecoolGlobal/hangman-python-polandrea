...
word_to_guess = "Paris" # sample data, normally the word should be chosen from the countries-and-capitals.txt
...
while game_over == False:
    ...
    already_tried_letters = ['a', 'i',] # this list will contain all the tried letters
    if letter in already_tried_letters:
        print("You've already guessed this letter. Heres your previous guesses:")
